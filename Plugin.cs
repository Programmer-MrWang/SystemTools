...
public class Plugin : PluginBase
{
    ...
    public override void Initialize(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddSingleton<MainWindowOcclusionAutoHideService>();
        ...
        AppBase.Current.AppStarted += (o, args) =>
        {
            ...
            IAppHost.GetService<MainWindowOcclusionAutoHideService>().Start();
    ...
    private void OnAppStopping(object? sender, EventArgs e)
    {
        ...
        IAppHost.GetService<MainWindowOcclusionAutoHideService>().Stop();
